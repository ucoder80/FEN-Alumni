                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div wire:ignore class="form-group">
                                        <select wire:model.live="roles_id" id="roles_id" class="form-control">
                                            <option value="">ເລືອກ-ຜູ້ໃຊ້
                                            </option>
                                            <option value="2">ພະນັກງານ</option>
                                            <option value="4">ລູກຄ້າ</option>
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="right_content">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 text-center">
                                                ...
                                                @elseif($this->roles_id == 4)
                                                    <h4><u><b>ລາຍງານ-ຂໍ້ມູນລູກຄ້າ</b></u></h4>
                                                @else
